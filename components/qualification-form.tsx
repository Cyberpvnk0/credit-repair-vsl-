...
const questions = [
  ...
  {
    id: "issue",
    question: "What is your main credit issue?",
    options: [
      { value: "collections", label: "Collections" },
      { value: "late-payments", label: "Late Payments" },
      { value: "charge-offs", label: "Charge-Offs" },
      { value: "bankruptcy", label: "Bankruptcy" },
      { value: "high-utilization", label: "High Credit Utilization" },
  ...
  },
  {
    ...
    options: [
      ...
      { value: "car", label: "Finance a Car" },
      { value: "business", label: "Start a Business" },
      { value: "credit-cards", label: "Get Credit Cards" },
      { value: "lower-rates", label: "Lower Interest Rates" },
      { value: "general", label: "General Improvement" }
    ]
  },
  {
    id: "timeline",
    question: "When do you need your credit fixed by?",
    options: [
        ...
        <div className="container mx-auto max-w-2xl px-4">
          <div className="rounded-xl border border-primary/20 bg-background p-6 text-center shadow-xl sm:rounded-2xl sm:p-8">
            ...
            <p className="mb-6 text-sm text-muted-foreground sm:mb-8 sm:text-base">
              Based on your answers, our credit repair program is a great fit for you. 
              Let&apos;s get started on improving your credit today.
            </p>
